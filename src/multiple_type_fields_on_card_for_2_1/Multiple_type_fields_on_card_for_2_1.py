""" This module monkey patches the anki Reviewer to
enable multiple type fields on cards. """
...
# This is only a constant attached to the reviewer
...
def myMaybeTextInput(self, txt: str, type: str = "q") -> str:
    ...
    if type == "q":
        repl = (
            "<input id='typeans' name='typetxt'"
            " type=text value='example' readonly='readonly'>"
        )
